...
var InputBar = function (_Component) {
  (0, _inherits3.default)(InputBar, _Component);
  ...
  function InputBar(props) {
    ...
    Object.defineProperty(_this, 'handleUpdate', {
      enumerable: true,
      writable: true,
      value: function value() {
        ...
        if (_this.props.onChangeSize) {
          _this.props.onChangeSize(width, height);
        }
      }
    });
  ...
  (0, _createClass3.default)(InputBar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { contentEditable: false, style: { position: 'absolute' } },
        'width: ',
        _react2.default.createElement(
          'span',
          null,
          _react2.default.createElement('input', (0, _extends3.default)({}, widthProps, { type: 'text' }))
        ),
        'height: ',
        _react2.default.createElement(
          'span',
...
var CustomizeExample = function (_Component2) {
  (0, _inherits3.default)(CustomizeExample, _Component2);
  ...
  function CustomizeExample() {
    ...
    return _ret = (_temp = (_this2 = (0, _possibleConstructorReturn3.default)(this, (_ref = CustomizeExample.__proto__ || (0, _getPrototypeOf2.default)(CustomizeExample)).call.apply(_ref, [this].concat(args))), _this2), Object.defineProperty(_this2, 'state', {
      enumerable: true,
      writable: true,
      value: {
        width: 0,
      ...
      value: function value(toolInfo) {
        if (_this2.props.isLog) {
          console.log('dragStart---->', toolInfo);
        }
      }
    }), Object.defineProperty(_this2, 'dragEnd', {
      enumerable: true,
      writable: true,
      value: function value(toolInfo) {
        // 更新拖拽后的数据到自定义拖拽栏下
    ...
    }), Object.defineProperty(_this2, 'dragging', {
      enumerable: true,
      writable: true,
      value: function value(toolInfo) {
        if (_this2.props.isLog) {
    ...
    }), Object.defineProperty(_this2, 'handleEvent', {
      enumerable: true,
      writable: true,
      value: function value(event) {
        event.stopPropagation();
      }
    }), Object.defineProperty(_this2, 'handleFocus', {
      enumerable: true,
      writable: true,
      value: function value() {
        _this2.setState({ isFocus: true });
      }
    }), Object.defineProperty(_this2, 'handleBlur', {
      enumerable: true,
      writable: true,
      value: function value() {
        _this2.setState({ isFocus: false });
      }
    }), Object.defineProperty(_this2, 'changeSize', {
      enumerable: true,
      writable: true,
      value: function value(width, height, toolInfo) {
    ...
    }), Object.defineProperty(_this2, 'handleClickImage', {
      enumerable: true,
      writable: true,
      value: function value(toolInfo) {
    ...
    }), Object.defineProperty(_this2, 'renderToolBar', {
      enumerable: true,
      writable: true,
      value: function value(toolInfo) {
        ...
        var _this2$state2 = _this2.state,
            width = _this2$state2.width,
            height = _this2$state2.height;
        ...
        var toolBarProps = {
          ...
          onChangeSize: function onChangeSize(width, height) {
            return _this2.changeSize(width, height, toolInfo);
          }
        };
        return _react2.default.createElement(InputBar, toolBarProps);
      }
...
var SimpleExample = function (_Component3) {
  (0, _inherits3.default)(SimpleExample, _Component3);
...
var Example = function (_Component4) {
  (0, _inherits3.default)(Example, _Component4);
  ...
  function Example() {
    ...
    }), Object.defineProperty(_this4, 'handlePoint', {
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(_this4, 'handleToolbar', {
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(_this4, 'handleLog', {
      enumerable: true,
      writable: true,
      value: function value() {
...
var _Drag = __webpack_require__("./src/Drag/index.js");

var _Drag2 = _interopRequireDefault(_Drag);

var _static = __webpack_require__("./src/static/index.js");

var _static2 = _interopRequireDefault(_static);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ImageDrag = function (_React$Component) {
  (0, _inherits3.default)(ImageDrag, _React$Component);
  ...
  function ImageDrag() {
    ...
    (0, _classCallCheck3.default)(this, ImageDrag);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = ImageDrag.__proto__ || (0, _getPrototypeOf2.default)(ImageDrag)).call.apply(_ref, [this].concat(args))), _this), Object.defineProperty(_this, 'state', {
      enumerable: true,
      writable: true,
      value: {
      ...
      value: function value() {
        ...
        var propsImageStyle = (0, _extends3.default)({}, imgStyle, {
          width: width || 600,
          height: height || 400,
          zIndex: 5
        });
        _this.setState({
          imgStyle: (0, _extends3.default)({}, propsImageStyle),
          blockStyle: (0, _extends3.default)({}, propsImageStyle, {
            display: 'block'
          }),
          markStyle: (0, _extends3.default)({}, propsImageStyle, {
            display: 'inline'
          }),
          imageInfo: {
            attr: attr || '',
      ...
      value: function value(even) {
        ...
        var isShow = disable.isFocus ? toolBar.isShow : toolBar.isFocus;
        if (!isShow) {
      ...
      value: function value(width, height) {
        ...
        var _this$state3 = _this.state,
            ...
            blockStyle = _this$state3.blockStyle,
            markStyle = _this$state3.markStyle;
        ...
        switch (imgStatus) {
          ...
          case _static2.default.BlockImage:
            _this.setState({
              blockStyle: (0, _extends3.default)({}, blockStyle, style)
            });
            break;
          case _static2.default.MarkChildren:
          case _static2.default.MarkImage:
            _this.setState({
              markStyle: (0, _extends3.default)({}, markStyle, style)
            });
            break;
          default:
            break;
      ...
      value: function value() {
        var _this$state7 = _this.state,
            ...
            disable = _this$state7.disable,
            toolBar = _this$state7.toolBar;
        var image = _this.props.image;

        var isShow = disable.isFocus ? toolBar.isShow : toolBar.isFocus;
        var isShowDrag = toolBar.isUse && isShow;
        var dragProps = {
          padding: 0,
          imgStatus: imgStatus,
          bgImg: image,
        ...
        return _react2.default.createElement(_Drag2.default, dragProps);
      }
      ...
      value: function value() {
        var _this$state8 = _this.state,
            ...
            disable = _this$state8.disable;

        var isShow = disable.isFocus ? toolBar.isShow : toolBar.isFocus;
        var isShowToolBar = toolBar.isUse && isShow;
  ...
  (0, _createClass3.default)(ImageDrag, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      this.init();
    }
